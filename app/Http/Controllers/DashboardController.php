...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        if (Session::get('login')) {
            ...
            $row['l'] = Student::where([['jk','Laki-Laki'],['tahun',date('Y')]])->count();
            $row['p'] = Student::where([['jk','Perempuan'],['tahun', date('Y')]])->count();
    ...
    {
        $student = Student::where('tahun',date('Y'))->count();
        $lecturer = Lecturer::count();
        $group = Group::where('tahun',date('Y'))->count();
