...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Data Pasca Sidang</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Data Pasca Sidang</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('pascasidang.create')}}" class="btn btn-primary modalnofooter-show" title="Tambah Data">Tambah</a>
                    </div>
                    <!-- /.card-header -->
