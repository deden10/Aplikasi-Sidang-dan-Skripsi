...
Route::resource('/viewprasidang','ViewprasidangController');
Route::any('/table/prasidangti', 'ViewprasidangController@dataTable')->name('table.prasti');
Route::any('/table/prasidangsi', 'ViewprasidangController@dataTable2')->name('table.prassi');
Route::any('/table/prasidangmi', 'ViewprasidangController@dataTable3')->name('table.prascami');